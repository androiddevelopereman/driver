        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ mode === 'add' ? 'Add New Driver' : 'Edit Driver' }}</h5>
                ...
                <form @submit.prevent="handleSubmit">
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="name" class="form-control" v-model="userData.name" required
                                    minlength="3" />
                            </div>
                            <div class="col-md-6">
                                <label for="mobile" class="form-label">Mobile # <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="mobile" class="form-control" v-model="userData.mobile" required
                                    pattern="^[0-9]+$" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="position" class="form-control" v-model="userData.position" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="licenseNumber" class="form-label">License # <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="licenseNumber" class="form-control"
                                    v-model="userData.licenseNumber" required />
                            </div>
                            <div class="col-md-6">
                                <label for="licenseType" class="form-label">License Type</label>
                                <select id="licenseType" class="form-select" v-model="userData.licenseType">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="licenseIssue" class="form-label">License Issue Date</label>
                                <input type="date" id="licenseIssue" class="form-control"
                                    v-model="userData.licenseIssue" />
                            </div>
                            <div class="col-md-6">
                                <label for="licenseExpiry" class="form-label">License Expiry Date <span
                                        class="text-danger">*</span></label>
                                <input type="date" id="licenseExpiry" class="form-control"
                                    v-model="userData.licenseExpiry" required />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="phone" class="form-control" v-model="userData.phone" />
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">{{ mode === 'add' ? 'Add Driver' : 'Save Changes'
                            }}</button>
                    </div>
                </form>
            </div>

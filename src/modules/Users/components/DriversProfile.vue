    ...
    <div class="filters-table">
        <div class="filter-left">
            ...
            <div class="export-button">
                <button class="btn-export" @click="toggleExport">{{ $t("Export") }}</button>
        ...
        <div class="columns-button">
            <button class="btn btn-primary my-3" data-bs-toggle="modal" data-bs-target="#driverModal"
                @click="openAddModal">
                {{ $t("Add Driver") }}
            </button>
...
const authData = {
    authorization: {
        token: "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vMTkyLjE2OC4xMDAuMjI6ODA5MS9hcGkvYXV0aC9sb2dpbiIsImlhdCI6MTczOTkxNTIzNiwiZXhwIjoxNzM5OTQ0MDM2LCJuYmYiOjE3Mzk5MTUyMzYsImp0aSI6IlY0U0U2cG1qbER0WE5JdEUiLCJzdWIiOiIzNjkiLCJwcnYiOiIyM2JkNWM4OTQ5ZjYwMGFkYjM5ZTcwMWM0MDA4NzJkYjdhNTk3NmY3In0.6RozPvHioVuRfzGv62I4sE_wV7j97EvRTa_2OUAQJvE",
    },
    user: {
        accounts: [
            {
